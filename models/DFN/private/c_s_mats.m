...
% An = diag(ones(N-1,1),1); %CASADI change
% Ap = diag(ones(N-1,1),1); %CASADI change
An = SX.zeros(N,N); %CASADI change
Ap = SX.zeros(N,N);
...
% An1 = Vn\An*Vn; %CASADI change
% Ap1 = Vp\Ap*Vp; %CASADI change
% 
% Bn1 = Vn\Bn; %CASADI change
% Bp1 = Vp\Bp; %CASADI change
...
% An2 = Vn2\An1*Vn2; %CASADI change
% Ap2 = Vp2\Ap1*Vp2; %CASADI change
% 
% Bn2 = Vn2\Bn1; %CASADI change
% Bp2 = Vp2\Bp1; %CASADI change
